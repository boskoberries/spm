	<div class="panel-ct" capt-num="<?=$number?>"> 					
		<label>Caption <?=$number?>:</label>
		<input class="caption-txt-input"  name="data[caption][body][]" placeholder="Caption <?=$number?> goes here" value="<?=(isset($caption))?$caption['body']:''?>"/>
