...
<div class="row">
	...
	<div class="sorting-links">
		...
		<? else:?>
			<b>Most Popular:</b>
			<a href="?sort=2" class="<?=(!isset($data['sort']) || $data['sort']=='2')?'active':''?>" title="most popular last 2 days">Last 2 Days</a>&nbsp;|&nbsp;
			<a href="?sort=7" class="<?=($data['sort']=='7')?'active':''?>" title="most popular last 7 days">Last 7 Days</a>&nbsp;|&nbsp;
			<a href="?sort=30" class="<?=($data['sort']=='30')?'active':''?>" title="most popular last 30 days">Last 30 Days</a>&nbsp;|&nbsp;
